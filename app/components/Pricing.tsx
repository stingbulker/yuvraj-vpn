  ...
  return (
    <div className="flex h-screen w-full flex-col gap-28 px-64 py-20">
      ...
      <div id="pricingCards" className="flex w-full gap-14 px-20">
        <div className="glass relative flex h-full w-full flex-col gap-10 overflow-hidden rounded-2xl px-10 py-8">
          <Badge className="!inner-shadow w-max rounded-xl border-accent/30">
          ...
          <Button
            size={"lg"}
            className="w-full py-4 text-2xl font-light"
            variant="grey"
          >
            Sign Up
          </Button>
          <div className="absolute -bottom-32 -right-20 h-3/4 w-3/4 rounded-full bg-accent opacity-10 blur-3xl"></div>
        </div>
        <div className="glass relative flex h-full w-full flex-col gap-10 overflow-hidden rounded-2xl px-10 py-8">
          <Badge className="!inner-shadow w-max rounded-xl border-accent/30">
          ...
          <div className="inline-block align-baseline">
            ...
            <span className={`text-2xl text-secondary-foreground`}>/month</span>
          </div>
          <div className="h-px w-full bg-white/10"></div>
          <div className="flex flex-col gap-3">
            <div className="flex items-center gap-2 text-xl font-light">
